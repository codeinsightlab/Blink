...
try {
  ...
  html = html
    ...
    .replace("<!-- seo:generated -->", meta.join("\n"));
  ...
  await writeFile(
    "dist/sitemap.xml",
    `<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">${origin ? `<url><loc>${origin}/</loc></url>` : ""}</urlset>`,
  );
